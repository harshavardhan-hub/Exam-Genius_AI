...
/**
 * ExamGenius AI - Admin Routes
 * Administrative functions for managing questions, tests, and users
 */
  ...
  try {
    ...
    for (const questionData of questions) {
      ...
      `, [
        ...
        correct_option,
        negative_mark || 2.0, // Updated default negative mark
...
// ✅ FIXED: Get all users with performance statistics (updated column name)
...
// ✅ FIXED: Get detailed reports for a specific user (updated column name)
